...
TELEGRAM_BOT_TOKEN = '7263989496:AAGfg369piwgzDpQ_-1-Uv98gAXwH7zmJsA'
ADMIN_USER_ID = 1221262658
...
async def attack(update: Update, context: CallbackContext):
    ...
    if len(args) != 3:
        await context.bot.send_message(chat_id=chat_id, text="*⚠️ Usage: /sun <ip> <port> <duration> 1200*", parse_mode='Markdown')
        return
